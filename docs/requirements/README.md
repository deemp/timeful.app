...
| [FR-121](functional/fr/FR-121.md) | Serve migrated records from a single authoritative store                                                                                                                                                                            | backend           |
...
| [QR-012](quality/qr/QR-012.md) | Preserve authorization when migrating core records                                    | backend, infrastructure |
